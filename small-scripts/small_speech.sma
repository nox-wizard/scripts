...
static msg_nxwlibDef[NUM_nxwlibSENT][]={
...
static msg_housemenuDef[NUM_housemenuSENT][]={
...
static msg_sk_anatomyDef[NUM_sk_anatomySENT][]={
...
static msg_sk_mainDef[NUM_sk_mainSENT][]={
...
static msg_sk_alchDef[NUM_sk_alchSENT][]={
"bloodmoss    ",
"garlic       ",
"sulfurous_ash",
"ginseng      ",
...
static msg_sk_miscDef[NUM_sk_miscSENT][]={
...
static msg_sk_cookDef[NUM_sk_cookSENT][]={
...
static msg_sk_dhiddenDef[NUM_sk_dhiddenSENT][]={
...
static msg_sk_evalintDef[NUM_sk_evalintSENT][]={
"Whom shall I examine?",
"Target invalid",
"You cannot analize yourself!",
"You need to be closer to find out more about them",
...
static msg_sk_fishDef[NUM_sk_fishSENT][]={
...
static msg_sk_inscripDef[NUM_sk_inscripSENT][]={
"Select scroll...",
...
const NUM_sk_lumbSENT = 17;
static msg_sk_lumbDef[NUM_sk_lumbSENT][]={
"pine    ",
"yew     ",
"maple   ",
"alder   ",
...
static msg_sk_meditDef[NUM_sk_meditSENT][]={
"You are in war mode!",
...
static msg_sk_miningDef[NUM_sk_miningSENT][]={
"iron    ",
"shadow  ",
"Merkit  ",
"Kupfer  ",
...
static msg_sk_tailorDef[NUM_sk_tailorSENT][]={
"You are not skilled enough for this kind of material."
}

const NUM_sk_tameSENT = 26;
static msg_sk_tameDef[NUM_sk_tameSENT][]={
...
static msg_sk_tasteDef[NUM_sk_tasteSENT][]={
...
const NUM_sk_trackSENT = 22;
static msg_sk_trackDef[NUM_sk_trackSENT][]={
...
static msg_api_partyDef[NUM_api_partySENT][]={
